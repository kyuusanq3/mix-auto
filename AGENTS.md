...
| Import Google Maps POI | Destination Search → **+** beside star → paste share link (`maps.app.goo.gl` needs network) or `lat, lng` → Confirm; short link expands via `GoogleMapsLinkParser`; star in POI detail to save; blocked during navigation |
